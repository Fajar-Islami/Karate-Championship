...
import { LoginBaruBG, SignUpBG } from "../../assets";
		...
		<MDBCarousel activeItem={1} length={3} showControls={true} showIndicators={true} style={{ height: full }} className="z-depth-1">
			<MDBCarouselInner>
				<MDBCarouselItem itemId="1">
					<MDBView>
						<img style={{ height: full }} className="d-block w-100" src={LoginBaruBG} alt="First slide" />
				...
				<MDBCarouselItem itemId="2">
					<MDBView>
						<img style={{ height: full }} className="d-block w-100" src={SignUpBG} alt="Second slide" />
