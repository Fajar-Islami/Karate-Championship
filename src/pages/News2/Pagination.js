...
const Pagination = ({ postsPerPage, totalPosts, paginate, currentPage }) => {
  ...
  return (
    <MDBPagination circle>
      ...
      <MDBPageItem disabled={currentPage === 1 ? true : false}>
        <MDBPageNav className="page-link" aria-label="Previous" onClick={() => paginate(currentPage - 1)}>
          &laquo;
        </MDBPageNav>
      </MDBPageItem>
      ...
      <MDBPageItem disabled={currentPage === pageNumbers.length ? true : false}>
        <MDBPageNav className="page-link" aria-label="Next" onClick={() => paginate(currentPage + 1)}>
          &raquo;
        </MDBPageNav>
      </MDBPageItem>
      <MDBPageItem disabled={currentPage === pageNumbers.length ? true : false}>
