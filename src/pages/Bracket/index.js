		...
		<Fragment>
			<MDBRow>
				<MDBCol className="mb-5">
					...
					<MDBRow>
						<MDBCol size="6">
							<TabelBracket kolom={["Male", "Status"]} baris={["Kata Individual Male Repechage", "Kata Individual Male Repechage", "Kumite Individual Male -52 KG Final", "Kumite Individual Male -52 KG Repechage", "Kumite Individual Male -52 KG Pool 1/2", "Kumite Individual Male -52 KG Pool 2/2", 
							"Kumite Individual Male -57 KG Final", "Kumite Individual Male -63 KG Final", 
							"Kumite Individual Male -70 KG Final", "Kumite Individual Male +70 KG Final", 
							"Kumite Individual Male Best of The Best Final"]} 
							isiKolom1={[Badge("", ""), Badge("", ""), Badge("Match Over", "danger"), 
							Badge("Match Over", "danger"), Badge("Match Over", "danger"), Badge("Match Over", "danger"), 
							Badge("Match Over", "danger"), Badge("Match Over", "danger"), Badge("Match Over", "danger"), 
							Badge("Match Over", "danger"), Badge("Match Over", "danger")]} />
						</MDBCol>
						<MDBCol size="6">
							<TabelBracket kolom={["Female", "Status"]} baris={["Kata Individual Female Repechage", 
							"Kata Individual Female Repechage", 
							"Kumite Individual Female -47 KG Final", "Kumite Individual Female -47 KG Repechage", 
							"Kumite Individual Female -54 KG Final", "Kumite Individual Female -54 KG Repechage",
							"Kumite Individual Female -54 KG Final", "Kumite Individual Female +54 KG Repechage",
							"Kumite Individual Female Best of The Best Final"]} 
							isiKolom1={[Badge("", ""), Badge("", ""), Badge("Match Over", "danger"),
							Badge("Match Over", "danger"),Badge("Match Over", "danger"),Badge("Match Over", "danger"),
							Badge("Match Over", "danger"),Badge("Match Over", "danger"),Badge("Match Over", "danger"),
							Badge("Match Over", "danger"),Badge("Match Over", "danger")]} />
					...
					<MDBRow>
						<MDBCol size="6">
							<TabelBracket kolom={["Male", "Status"]} baris={["Kata Individual Male Repechage", 
							"Kata Individual Male Repechage", "Kata Team Male Repechage", "Kata Team Male Repechage",
							"Kumite Individual Male -55 KG Final", "Kumite Individual Male -55 KG Repechage",
							"Kumite Individual Male -55 KG Pool 1/2", "Kumite Individual Male -55 KG Pool 2/2",
							"Kumite Individual Male -61 KG Final", "Kumite Individual Male -61 KG Repechage", 
							"Kumite Individual Male -68 KG Final", "Kumite Individual Male -68 KG Repechage",
							"Kumite Individual Male -68 KG Pool 1/2", "Kumite Individual Male -68 KG Pool 2/2", 
							"Kumite Individual Male -76 KG Final", "Kumite Individual Male -76 KG Repechage", 
							"Kumite Individual Male +76 KG Final", 	"Kumite Individual Male Best of The Best Final"]} 
							isiKolom1={[Badge("", ""), Badge("", ""), Badge("", ""), 
							Badge("Match Over", "danger"), Badge("Match Over", "danger"), Badge("Match Over", "danger"), 
							Badge("Match Over", "danger"), Badge("Match Over", "danger"), Badge("Match on Tatami 3", "green"), 
							Badge("Match Over", "danger"), Badge("Match Over", "danger"), Badge("Match Over", "danger")
							, Badge("Match Over", "danger"), Badge("Match Over", "danger"), Badge("Match Over", "danger")
							, Badge("Match Over", "danger"), Badge("Match Over", "danger"), Badge("Match Over", "danger")]} />
						</MDBCol>
						<MDBCol size="6">
							<TabelBracket kolom={["Female", "Status"]} baris={["Kata Individual Female Repechage", 
							"Kata Individual Female Repechage", "Kata Team Female Repechage", 
							"Kumite Individual Female -48 KG Final", "Kumite Individual Female -48 KG Repechage", 
							"Kumite Individual Female -53 KG Final", "Kumite Individual Female -53 KG Repechage",
							"Kumite Individual Female -59 KG Final", "Kumite Individual Female -59 KG Repechage",
							"Kumite Individual Female +59 KG Final", "Kumite Individual Female +59 KG Repechage",
							"Kumite Individual Female Best of The Best Final"]} 
							isiKolom1={[Badge("", ""), Badge("", ""), Badge("", ""),
							Badge("Match Over", "danger"),Badge("Match Over", "danger"),Badge("Match Over", "danger"),
					...
					<MDBRow>
						<MDBCol size="6">
							<TabelBracket kolom={["Male", "Status"]} baris={["Kata Individual Male Repechage", 
							"Kata Individual Male Repechage", "Kata Team Male Repechage",
							"Kumite Individual Male -60 KG Final", "Kumite Individual Male -60 KG Repechage",
							"Kumite Individual Male -67 KG Final", "Kumite Individual Male -67 KG Repechage",  
							"Kumite Individual Male -75 KG Final", "Kumite Individual Male -84 KG Final", 
							"Kumite Individual Male +84 KG Final", 	"Kumite Individual Male Best of The Best Final"]} 
							isiKolom1={[Badge("", ""), Badge("", ""), Badge("", ""), 
							Badge("Match Over", "danger"), Badge("Match Over", "danger"), 
							Badge("Match Over", "danger"), Badge("Match Over", "danger"), Badge("Match Over", "danger"), 
							Badge("Match Over", "danger"), Badge("Match Over", "danger"), Badge("Match Over", "danger")
						...
						<MDBCol size="6">
							<TabelBracket kolom={["Female", "Status"]} baris={["Kata Individual Female Repechage", 
							"Kata Individual Female Repechage", "Kata Team Female Repechage", 
							"Kumite Individual Female -50 KG Final", "Kumite Individual Female -50 KG Repechage", 
							"Kumite Individual Female -55 KG Final", "Kumite Individual Female -61 KG Final",
							"Kumite Individual Female -61 KG Repechage", "Kumite Individual Female -68 KG Final",
							"Kumite Individual Female Best of The Best Final"]} 
							isiKolom1={[Badge("", ""), Badge("", ""), Badge("", ""),
							Badge("Match Over", "danger"),Badge("Match Over", "danger"),Badge("Match Over", "danger"),
							Badge("Match Over", "danger"),Badge("Match Over", "danger"),Badge("Match Over", "danger"),
					...
					<MDBRow>
						<MDBCol size="6">
							...
							"Kumite Individual Male -60 KG Final", "Kumite Individual Male -67 KG Final",
							"Kumite Individual Male -75 KG Final","Kumite Individual Male +84 KG Final", 
							"Kumite Individual Male +84 KG Repechage", 
							"Kumite Individual Male Best of The Best Final"]} 
							isiKolom1={[Badge("", ""), Badge("", ""), 
							Badge("Match Over", "danger"), Badge("Match Over", "danger"), Badge("Match Over", "danger"), 
							Badge("Match Over", "danger"), Badge("Match Over", "danger"), Badge("Match Over", "danger")
							, Badge("Match Over", "danger"), Badge("Match Over", "danger")]} />
						</MDBCol>
						<MDBCol size="6">
							<TabelBracket kolom={["Female", "Status"]} baris={["Kata Individual Female Repechage", 
							"Kata Individual Female Repechage", 
							"Kumite Individual Female -50 KG Final", "Kumite Individual Female -55 KG Final", 
							"Kumite Individual Female -61 KG Final", "Kumite Individual Female -68 KG Final",
							"Kumite Individual Female Best of The Best Final"]} 
							isiKolom1={[Badge("", ""), Badge("", ""),
							Badge("Match Over", "danger"),Badge("Match Over", "danger"),Badge("Match Over", "danger"),
							Badge("Match Over", "danger"),Badge("Match Over", "danger"),Badge("Match Over", "danger"),]} />
