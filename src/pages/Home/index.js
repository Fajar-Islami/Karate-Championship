                ...
                <MDBView>
                  <MDBCardGroup className='d-lg-flex  justify-content-around '>
                    <MDBCol lg='6' sm='12'>
                      <h5>Kategori 1</h5>
                      <TabelMatches
                        data={UpcomingMatch.kategori_1}
                        upcomingM='true'
                      />
                      <h5>Kategori 2</h5>
                      <TabelMatches
                        data={UpcomingMatch.kategori_2}
                        upcomingM='true'
                      />
                    </MDBCol>
                    <MDBCol lg='6' sm='12'>
                      <h5>Kategori 3</h5>
                      <TabelMatches
                        data={UpcomingMatch.kategori_3}
                        upcomingM='true'
                      />
                      <h5>Kategori 4</h5>
                      <TabelMatches
                        data={UpcomingMatch.kategori_4}
                        upcomingM='true'
                      />
                    </MDBCol>
                  </MDBCardGroup>
                ...
                <MDBView>
                  <MDBCardGroup className='d-lg-flex  justify-content-around '>
                    <MDBCol lg='6' sm='12'>
                      <h5>Kategori 5</h5>
                      <TabelMatches
                        data={UpcomingMatch.kategori_5}
                        upcomingM='true'
                      />
                      <h5>Kategori 6</h5>
                      <TabelMatches
                        data={UpcomingMatch.kategori_6}
                        upcomingM='true'
                      />
                    </MDBCol>
                    <MDBCol lg='6' sm='12'>
                      <h5>Kategori 7</h5>
                      <TabelMatches
                        data={UpcomingMatch.kategori_7}
                        upcomingM='true'
                      />
                      <h5>Kategori 8</h5>
                      <TabelMatches
                        data={UpcomingMatch.kategori_8}
                        upcomingM='true'
                      />
                    </MDBCol>
                  </MDBCardGroup>
